#define RSDL_LEVELS           1  // Number of priority levels
#define RSDL_STARTING_LEVEL   0  // Priority level all new processes will be assigned to  (must be from 0 to RSDL LEVELS-1)
